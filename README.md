...
🚀 Getting Started
To use this application, you'll need to have Ollama installed and at least one LLM model downloaded (e.g., llama3 or gemma2).

1. Install Ollama & Download an LLM
Download Ollama: Visit https://ollama.com/download and download the appropriate version for your operating system (Windows, macOS, Linux).

Install Ollama: Follow the installation instructions for your system.

Download an LLM Model: Open your terminal or command prompt and download a model. For example:
...
Go to our GitHub Releases page (or the designated download location).
...
If the Executable Isn't Working:
...
git clone https://github.com/BitWattr/BitWattr-Repo.git
cd BitWattr-Repo
...
📞 Contact
For questions, issues, or contributions, please visit our GitHub repository and open an issue or pull request.
